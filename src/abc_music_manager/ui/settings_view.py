...
class SettingsView(QWidget):
    ...
    def _build_account_targets_tab(self) -> QWidget:
        ...
        scan_btn.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
    ...
    def _build_playback_tab(self) -> QWidget:
        ...
        tempo_row.addWidget(QLabel("Default tempo (0.25×–4×):"))
        self.playback_tempo_spin = QDoubleSpinBox()
        self.playback_tempo_spin.setRange(0.25, 4.0)
